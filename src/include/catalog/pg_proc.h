...
DATA(insert OID = 4399 ( levenshtein_fast		   PGNSP PGUID 12 1 0 0 f f f t f i 3 0 20 "25 25 20" _null_ _null_ _null_ _null_ levenshtein_fast  _null_ _null_ _null_ ));
...
/* keep the following ordered by OID so that later changes can be made easier ---bullshit*/
